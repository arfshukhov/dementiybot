...
async def send_welcome(message: types.Message):
    await message.reply("Привет, я админ-бот Дементий от @Harfile\n"
                        ...
                        '/demotivator - функция создает демотиваторы, имеет схожий с биндами синтаксис, в ответ на '
                        'пичку, к которой хотите создать демотивтор  пропишите /demotivator заголовок|текст\n'
                        'аргументы указываются через верт. черту, первый аргумент обязателен, второй опционален.\n'
                        ...
                        '-Новым участникам чата должны быть видны все сообщения\n'
